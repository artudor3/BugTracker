...
namespace BugTracker.Controllers
{
    public class TicketHistoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PropertyName,Description,Modified,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PropertyName,Description,Modified,OldValue,NewValue,TicketId,UserId")] TicketHistory ticketHistory)
        {
