...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,FileName,FileData,FileContentType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,FileName,FileData,FileContentType,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
